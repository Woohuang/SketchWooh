...
/***/ "./src/Auto Refresh Switch [ars].js":
/*!******************************************!*\
  !*** ./src/Auto Refresh Switch [ars].js ***!
  \******************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  Object(_modules_Google_Analytics_Method__WEBPACK_IMPORTED_MODULE_1__["default"])(autoRefreshKey);
});
...
function artboardBrowse(pageTitle, refreshInterval) {
  if (artboard === 0) {
    ...
    var artboardname = pageTitle; //artboardname = artboardname.replace(/['|'|/|#|.|\\|"|"]/g, '')
    ...
    var htmlContent = NSString.stringWithString_("<html><head><meta charset='UTF-8'></head><body style='overflow:!hidden; text-align: center; margin: 0; padding: 0; background:" + colorToRGBA(artboard.sketchObject.backgroundColor()) + ";'> <img id='mainImg' width=" + artboard.sketchObject.frame().width() + " src='./" + artboardname + ".png' center top no-repeat;'></body><script>setInterval(function(){document.getElementById('mainImg').src=document.getElementById('mainImg').src+'?t='+Math.random();}," + refreshInterval + "); </script></html > "); //let htmlContent = NSString.stringWithString_("<html><head><meta charset='UTF-8'></head><body style='overflow:!hidden; text-align: center; margin: 0; padding: 0; background:" + colorToRGBA(artboard.sketchObject.backgroundColor()) + ";'> <img id='mainImg' width=" + (artboard.sketchObject.frame()).width() + " src='./" + artboardname + ".png' center top no-repeat;'></body><script>setInterval(function(){document.getElementById('mainImg').src=document.getElementById('mainImg').src+'?t='+Math.random();},500);</script></html>");
...
//# sourceMappingURL=Auto Refresh Switch [ars].js.map