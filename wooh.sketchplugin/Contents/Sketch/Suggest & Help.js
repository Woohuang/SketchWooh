...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/Suggest & Help.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
      ...
      if (value.length < 120) {
        ...
        UI.getInputFromUser("And your contact if possible", {
          ...
          if (err) {
            ...
            userContact = value; //toast message

            sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("Thanks~");
          }
        });
      } else {
  ...
  userWords = userContact + "✚" + userWords; //GA

  Object(_modules_Google_Analytics_Method__WEBPACK_IMPORTED_MODULE_1__["default"])(userWords);
});
