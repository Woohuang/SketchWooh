...
var Selection = doc.selectedLayers.layers; //let SymbolInstance = require('sketch/dom').SymbolInstance
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var CopiedInfo = Settings.settingForKey('copySymbolInfo').split("_.0._.0._.0._");
  var CopiedId = CopiedInfo[0];
  var CopiedOverrides = doc.getLayerWithID(CopiedId).overrides;
  var CopiedOverridesLen = CopiedOverrides.length;
  var Result = 0;
  Selection.forEach(function (item) {
    ...
    if (item.type === "SymbolInstance") {
      for (var i = 0; i < CopiedOverridesLen && i < item.overrides.length; i++) {
  ...
  if (Result === 1) {
    ...
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("Fail Because Of The Not Similar Symbol");
  } //GA
...
/***/ 0:
/*!***********************************************************!*\
  !*** multi @babel/polyfill ./src/Paste Overrides [po].js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! @babel/polyfill */"./node_modules/@babel/polyfill/lib/index.js");
module.exports = __webpack_require__(/*! /Users/huangyu2/Wooh_Code/Xscape/SketchPlugin/src/Paste Overrides [po].js */"./src/Paste Overrides [po].js");
...
//# sourceMappingURL=Paste Overrides [po].js.map