...
/***/ "./src/Select Layer By Text Content [slbtc].js":
/*!*****************************************************!*\
  !*** ./src/Select Layer By Text Content [slbtc].js ***!
  \*****************************************************/
  ...
  UI.getInputFromUser("Input Key Text", {
    ...
    if (err) {
      return;
        ...
        CopiedString = value;
        var SearchTexts = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.find('Text', doc.selectedPage).filter(function (item) {
          return item.text.indexOf(CopiedString) !== -1;
        });
        var SearchInstances = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.find('SymbolInstance', doc.selectedPage).filter(function (item) {
          return item.overrides.findIndex(function (item2) {
            return item2.affectedLayer.type === "Text" && item2.value.indexOf(CopiedString) !== -1;
          }) !== -1;
        });
        var SearchLayers = SearchTexts.concat(SearchInstances);
...
/***/ 0:
/*!***************************************************************************!*\
  !*** multi @babel/polyfill ./src/Select Layer By Text Content [slbtc].js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! @babel/polyfill */"./node_modules/@babel/polyfill/lib/index.js");
module.exports = __webpack_require__(/*! /Users/huangyu2/Wooh_Code/Xscape/SketchPlugin/src/Select Layer By Text Content [slbtc].js */"./src/Select Layer By Text Content [slbtc].js");
...
//# sourceMappingURL=Select Layer By Text Content [slbtc].js.map