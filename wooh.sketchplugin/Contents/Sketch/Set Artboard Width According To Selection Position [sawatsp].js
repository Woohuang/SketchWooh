...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/Set Artboard Width According To Selection Position [sawatsp].js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var CopyNumber = 0;
  var artboardSizeFilter = 0;
  var CopyResult = 0;

  if (string !== null) {
    CopyNumber = (string.split(">")[0] - 0) * 1;
    artboardSizeFilter = (string.split(">")[1] - 0) * 1;
  }
  ...
  Selection.forEach(function (item) {
    ...
    var findParentGroup = item,
        findParentGroupPositionX = item.frame.x + item.frame.width;
    ...
    for (;;) {
      if (findParentGroup.parent) {
        if (findParentGroup.parent.type === "Group") {
          ...
          findParentGroupPositionX = findParentGroupPositionX + findParentGroup.frame.x;
        } else {
          break;
        }
      }
    ...
    if (item.getParentArtboard().frame.width > artboardSizeFilter) {
      item.getParentArtboard().frame.width = findParentGroupPositionX + CopyNumber;
    }
  });
