...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  if (string != "....") {
    ...
    colorPicker.setBackgroundColor(NSColor.whiteColor()); // show buttons?
    ...
    colorPicker.standardWindowButton(NSWindowZoomButton).setHidden(true); // Titlebar
    ...
    threadDictionary[identifier] = colorPicker; // Add Web View to window
    ...
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("OK2");
  }
});
