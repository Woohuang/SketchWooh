...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var TS_TxtStyles = TS_doc.sharedTextStyles,
      ...
      TS_Colors = TS_doc.colors; //同步 TheSource 的字体样式至 TC
  ...
  var _loop = function _loop(i, len) {
    ...
    var CurrentStyleId = TC_doc.sharedTextStyles[i].id,
        Judge = TS_TxtStyles.findIndex(function (item) {
  ...
  var _loop2 = function _loop2(_i, _len) {
    ...
    var CurrentStyleId = TC_doc.sharedLayerStyles[_i].id,
        Judge = TS_LayerStyles.findIndex(function (item) {
      return item.id === CurrentStyleId;
    });
  ...
  console.log("success: 同步 TheSource 的 🔗Symbols 至 TC"); //同步 TheSource 的 🍭Styles 中的非 CustomSymnbols 至 TC
  ...
  var TS_Styles_Index = TS_doc.pages.findIndex(function (item) {
    return item.name === "🍭Styles";
      ...
      TC_Styles_Index = TC_doc.pages.findIndex(function (item) {
    return item.name === "🍭Styles";
  }),
      TC_CuStyles_Index = TC_doc.pages.findIndex(function (item) {
...
/***/ 0:
/*!*********************************************************************!*\
  !*** multi @babel/polyfill ./src/Sync All From TheSource [saft].js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! @babel/polyfill */"./node_modules/@babel/polyfill/lib/index.js");
module.exports = __webpack_require__(/*! /Users/huangyu2/Wooh_Code/Xscape/SketchPlugin/src/Sync All From TheSource [saft].js */"./src/Sync All From TheSource [saft].js");
