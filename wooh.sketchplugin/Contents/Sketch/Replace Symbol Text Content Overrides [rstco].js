...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/Replace Symbol Text Content Overrides [rstco].js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/Replace Symbol Text Content Overrides [rstco].js":
/*!**************************************************************!*\
  !*** ./src/Replace Symbol Text Content Overrides [rstco].js ***!
  \**************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var copiedOverrides = doc.getLayerWithID(CopiedId).overrides; //let copiedOverridesLen = copiedOverrides.length
  ...
  Selection.forEach(function (item) {
    ...
    if (item.type === "SymbolInstance") {
      var itemTextOverrides = item.overrides.filter(function (item2) {
        return item2.editable === true && item2.property === "stringValue";
      }),
          copiedTextOverrides = copiedOverrides.filter(function (item2) {
        return item2.editable === true && item2.property === "stringValue";
      });

      for (var i = 0; i < copiedTextOverrides.length && i < itemTextOverrides.length; i++) {
...
//# sourceMappingURL=Replace Symbol Text Content Overrides [rstco].js.map