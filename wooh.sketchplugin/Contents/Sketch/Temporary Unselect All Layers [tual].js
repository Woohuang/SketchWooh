...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/Temporary Unselect All Layers [tual].js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./src/Temporary Unselect All Layers [tual].js":
/*!*****************************************************!*\
  !*** ./src/Temporary Unselect All Layers [tual].js ***!
  \*****************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var SelectedLayersId, Selected, DocId, PageId, SelectedLayers; // SelectedLayers = sketch.find('[Selected=true]', doc.selectedPage)
  ...
  if (!settings.sessionVariable('ReadSelectedInfo')) {
    SelectedLayersId = [], Selected = 1, DocId = null, PageId = null;
      ...
      PageId = settings.sessionVariable('ReadSelectedInfo').PageId; //储存的锁定图层数量为 0 时
  ...
  if (settings.sessionVariable('ReadSelectedInfo').Selected === 1) {
    ...
    for (var i = 0, len = SelectedLayers.length; i < len; i++) {
      SelectedLayersId.splice(0, 0, SelectedLayers[i].id);
    }
...
//# sourceMappingURL=Temporary Unselect All Layers [tual].js.map