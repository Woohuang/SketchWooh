...
/***/ "./src/Select Log Corresponding Artboard [slca].js":
/*!*********************************************************!*\
  !*** ./src/Select Log Corresponding Artboard [slca].js ***!
  \*********************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var LogTexts = Selection.filter(function (item) {
    return Settings.layerSettingForKey(item, 'ArtboardIds') !== undefined;
  ...
  if (LogTexts.length > 0) {
    ...
    var ArtboardIdString = new String();
    var ArtboardIds = [];
    var SelecteResult = 0;
    LogTexts.forEach(function (item) {
      ArtboardIdString = ArtboardIdString + Settings.layerSettingForKey(item, 'ArtboardIds');
    });
    ArtboardIdString.split("_next_").forEach(function (item) {
      if (ArtboardIds.findIndex(function (item2) {
        return item2 === item;
      }) === -1) {
    ...
    ArtboardIds.forEach(function (item) {
      var ThisArtboardIndex = AllArtboards.findIndex(function (item2) {
    ...
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("Succeed In Selecting " + SelecteResult + " Artboards");
  } //selected LogTexts num < 0
  else {
      sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("Please Select At Least 1 Log Text Layer");
    } //GA
...
/***/ 0:
/*!*******************************************************************************!*\
  !*** multi @babel/polyfill ./src/Select Log Corresponding Artboard [slca].js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! @babel/polyfill */"./node_modules/@babel/polyfill/lib/index.js");
module.exports = __webpack_require__(/*! /Users/huangyu2/Wooh_Code/Xscape/SketchPlugin/src/Select Log Corresponding Artboard [slca].js */"./src/Select Log Corresponding Artboard [slca].js");
...
//# sourceMappingURL=Select Log Corresponding Artboard [slca].js.map